...
//        }
//        if (n == 1) {
//            return String.format("%.7f", 1.0 * (k - 1) / k);
//        }
//        Collections.sort(p);
//        List<Integer> nums = new ArrayList<>();
//        int curIndex = 0;
...
//        }
//        while (curIndex != n - 1) {
//            Integer cur = p.get(curIndex);
//            Integer next = p.get(curIndex + 1);
//            if (next > cur) {
//                nums.add((next - cur) / 2);
//            }
//            curIndex++;
//        }
//        nums.add(k - p.get(curIndex));
//        Collections.sort(nums);
////        int num = nums.get(0);
////        int num2 = nums.get(1);
////        if (num2 > num) {
...
////            }
////        }
//        return String.format("%.7f", 1.0 * (nums.get(nums.size() - 1) + nums.get(nums.size() - 2)) / k);
//    }
//}
